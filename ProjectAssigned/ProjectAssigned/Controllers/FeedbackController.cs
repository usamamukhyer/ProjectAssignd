...
namespace ProjectAssigned.Controllers
{
    public class FeedbackController : Controller
    {
        ...
        //    list.Add("Previous Project");
        //    list.Add("New Module");
        //    ViewBag.ProjectType = new SelectList(list);
        ...
        //public JsonResult GetProjectDeveloper(int id)
        //{
        ...
        //}
        //public JsonResult GetNewModuleDeveloper(int id)
        //{
        //    db.Configuration.ProxyCreationEnabled = false;
        //    var project = db.NewModules.AsNoTracking().Where(x => x.ModuleId== id).FirstOrDefault();
        //    var developer = db.CreateDevelopers.Where(x => x.Developer_Id == project.Developer_Id).ToList();
